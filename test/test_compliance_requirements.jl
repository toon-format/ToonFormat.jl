...
@testset "Compliance: All Requirements" begin
    @testset "Requirement 1: Data Model Compliance" begin
        ...
        @test TOON.decode(TOON.encode("string")) == "string"
    ...
    @testset "Requirement 2: Number Formatting and Precision" begin
        ...
        @test !endswith(TOON.encode(1.5), "0")
    ...
    @testset "Requirement 3: String Escaping and Quoting" begin
        ...
        @test occursin("\"", TOON.encode("has,comma", options=opts))
    ...
    @testset "Requirement 4: Array Header Syntax" begin
        ...
        result = TOON.decode("[5]: 1,2,3,4,5")
        ...
        @test_throws Exception TOON.decode("[3] 1,2,3")
    end
    ...
    @testset "Requirement 5: Object Encoding and Decoding" begin
        ...
        @test_throws Exception TOON.decode("name Alice")
    ...
    @testset "Requirement 7: Tabular Array Format" begin
        ...
        @test_throws Exception TOON.decode("[2]{a,b}:\n  1,2\n  3")
        
        # 7.6: Strict mode errors on row count mismatch
        @test_throws Exception TOON.decode("[3]{a,b}:\n  1,2\n  3,4")
    end
    ...
    @testset "Requirement 9: Indentation and Whitespace" begin
        ...
        @test_throws Exception TOON.decode(input)
    ...
    @testset "Requirement 10: Strict Mode Validation" begin
        ...
        @test_throws Exception TOON.decode("[5]: 1,2,3")
        
        # 10.2: Error on list array count mismatch
        @test_throws Exception TOON.decode("[3]:\n  - a\n  - b")
        ...
        @test_throws Exception TOON.decode("[2]:\n  - a\n\n  - b")
    end
    ...
    @testset "Requirement 14: Path Expansion" begin
        ...
        input = "a: 1\na.b: 2"
        opts = TOON.DecodeOptions(expandPaths="safe", strict=true)
        @test_throws Exception TOON.decode(input, options=opts)
        
        # 14.5: Non-strict uses last-write-wins
        input = "a: 1\na.b: 2"
        opts = TOON.DecodeOptions(expandPaths="safe", strict=false)
        result = TOON.decode(input, options=opts)
        @test result["a"]["b"] == 2
    end
    ...
    @testset "Requirement 15: Conformance and Options" begin
        ...
        arr = [1, 2, 3]
        opts = TOON.EncodeOptions(delimiter=TOON.TAB)
        result = TOON.encode(arr, options=opts)
        @test occursin("\t", result)
        ...
        @test_nowarn TOON.decode(input, options=opts)
