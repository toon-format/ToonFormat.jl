...
@testset "Compliance: All Requirements" begin
    @testset "Requirement 1: Data Model Compliance" begin
        ...
        @test ToonFormat.decode(ToonFormat.encode("string")) == "string"
        ...
        @test isa(ToonFormat.decode(ToonFormat.encode(Dict("a" => 1))), AbstractDict)
        @test isa(ToonFormat.decode(ToonFormat.encode([1, 2, 3])), Vector)
    ...
    @testset "Requirement 2: Number Formatting and Precision" begin
        ...
        @test !endswith(ToonFormat.encode(1.5), "0")
        ...
        @test ToonFormat.decode("value: 42")["value"] == 42
        ...
        @test ToonFormat.decode("code: 05")["code"] == "05"
        @test isa(ToonFormat.decode("code: 05")["code"], String)
    end
    ...
    @testset "Requirement 3: String Escaping and Quoting" begin
        ...
        @test occursin("\"", ToonFormat.encode("has,comma", options = opts))
    ...
    @testset "Requirement 4: Array Header Syntax" begin
        ...
        result = ToonFormat.decode("[5]: 1,2,3,4,5")
    ...
    @testset "Requirement 8: Delimiter Scoping and Quoting" begin
        ...
        result = ToonFormat.decode("[3]: a,,c")
        @test result[2] == ""
    end
    ...
    @testset "Requirement 10: Strict Mode Validation" begin
        ...
        @test_throws Exception ToonFormat.decode("[5]: 1,2,3")
    ...
    @testset "Requirement 15: Conformance and Options" begin
        ...
        arr = [1, 2, 3]
        opts = ToonFormat.EncodeOptions(delimiter = ToonFormat.TAB)
        result = ToonFormat.encode(arr, options = opts)
        @test occursin("\t", result)
